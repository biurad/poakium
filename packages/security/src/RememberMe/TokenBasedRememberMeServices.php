...
class TokenBasedRememberMeServices extends AbstractRememberMeServices
{
    ...
    protected function processAutoLoginCookie(array $cookieParts, Request $request)
    {
        ...
        if (true !== hash_equals($this->generateCookieHash($class, $username, (int) $expires, $user->getPassword()), $hash)) {
    ...
    protected function onLoginSuccess(Request $request, TokenInterface $token)
    {
        ...
        $value = $this->generateCookieValue(get_class($user), $user->getUsername() ?? $user->getEmail(), $expires, $user->getPassword());
