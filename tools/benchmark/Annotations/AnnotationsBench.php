...
namespace Biurad\Benchmark\Annotations;
 ...
 * @Revs(500)
 */
class AnnotationsBench
{
    protected const DIRECTORIES = [
        __DIR__.'/../../../packages/annotations/tests/Fixtures/Annotation/Valid',
        __DIR__.'/../../../packages/annotations/tests/Fixtures/Annotation/Attribute',
